...
router.get('/balances/:userId', authorize('SUPER_ADMIN', 'MANAGER', 'HR'), leaveController.getUserBalance);
router.put('/balance/:userId/extra', authorize('SUPER_ADMIN', 'MANAGER', 'HR'), leaveController.addExtraLeaves);
router.put('/balance/:userId/adjust', authorize('SUPER_ADMIN'), leaveController.adjustExtraLeaves);
router.put('/balances/bulk-extra', authorize('SUPER_ADMIN', 'MANAGER', 'HR'), leaveController.addExtraLeavesBulk);
router.get('/requests', leaveController.getRequests);
router.post('/requests', leaveController.createRequest);
router.patch('/requests/:id', leaveController.updateRequest);
router.get('/requests/:id', leaveController.getOne);
router.delete('/requests/:id', leaveController.deleteRequest);
router.put('/requests/:id/review', authorize('SUPER_ADMIN', 'MANAGER', 'HR'), leaveController.review);
router.get('/other-requests', leaveController.getOtherRequests);
router.post('/other-requests', leaveController.createOtherRequest);
router.put('/other-requests/:id/review', authorize('SUPER_ADMIN', 'MANAGER', 'HR'), leaveController.reviewOther);
