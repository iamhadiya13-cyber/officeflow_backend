...
router.put('/balance/:userId/extra', authorize('SUPER_ADMIN','MANAGER'), leaveController.addExtraLeaves);
router.put('/balance/:userId/adjust', authorize('SUPER_ADMIN','MANAGER'), leaveController.adjustExtraLeaves);
router.put('/balances/bulk-extra', authorize('SUPER_ADMIN','MANAGER'), leaveController.addExtraLeavesBulk);
