...
router.put('/:id/review', authorize('SUPER_ADMIN', 'MANAGER', 'HR'), tripController.review);
router.put('/:id/complete', authorize('SUPER_ADMIN', 'MANAGER', 'HR'), tripController.complete);
